...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailSignIn = (EditText) findViewById(R.id.editText);
        passwordSignIn = (EditText) findViewById(R.id.editText2);
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    if (password.length() < 6) {
                                        passwordSignIn.setError("Error fuckin error");
                                    } else {
    ...
    public void signUp(View view) {
        Intent i = new Intent(LoginActivity.this, sign_In_Activity.class);
        startActivity(i);
    }
}
